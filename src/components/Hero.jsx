...
const Hero = () => (
  ...
  >
    <div
      className={`md:mr-5 px-8 py-4 max-md:mb-4 w-full h-full rounded-xl bg-[#DFF1E6] flex flex-col justify-center items-center`}
    >
      <p
        className={`${styles.paragraph} font-poppins font-semibold text-[#112E2B] text-center`}
      >
    ...
    <div
      className={`md:ml-5 max-md:mb-5 w-full h-full rounded-xl bg-[#112E2B] flex justify-center`}
    >
